...
void Tracking::ReceiveImage(const lcm::ReceiveBuffer* rbuf,const std::string& chan,const ORB_Types::Image* msg)
{
...
bool Tracking::Relocalisation()
{
    ...
    {
         std::lock_guard<std::mutex> lock(mMutexForceRelocalisation);
